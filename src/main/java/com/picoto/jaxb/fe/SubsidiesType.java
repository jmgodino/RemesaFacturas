...
public class SubsidiesType {
    ...
    protected List<SubsidyType> subsidies;
     ...
     * This is why there is not a <CODE>set</CODE> method for the subsidies property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSubsidies().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SubsidyType> getSubsidies() {
        if (subsidies == null) {
            subsidies = new ArrayList<SubsidyType>();
        }
