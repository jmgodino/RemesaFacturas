...
public class DeliveryNotesReferencesType {
    ...
    protected List<DeliveryNoteType> deliveryNotes;
     ...
     * This is why there is not a <CODE>set</CODE> method for the deliveryNotes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDeliveryNotes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DeliveryNoteType> getDeliveryNotes() {
        if (deliveryNotes == null) {
            deliveryNotes = new ArrayList<DeliveryNoteType>();
        }
