...
public class AdministrativeCentresType {
    ...
    protected List<AdministrativeCentreType> administrativeCentres;
     ...
     * This is why there is not a <CODE>set</CODE> method for the administrativeCentres property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAdministrativeCentres().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AdministrativeCentreType> getAdministrativeCentres() {
        if (administrativeCentres == null) {
            administrativeCentres = new ArrayList<AdministrativeCentreType>();
        }
        return this.administrativeCentres;
    }
